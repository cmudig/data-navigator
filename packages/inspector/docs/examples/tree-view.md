...
<div id="tree-commands-container"></div>
...
<div style="display: flex; gap: 2em; flex-wrap: wrap; align-items: flex-start;">
    <div>
        ...
        <div id="tree-chart-wrapper" style="position: relative;"></div>
    </div>
    <div>
        <h3>Force Graph</h3>
        <div id="tree-force-inspector" style="min-height: 350px;"></div>
    </div>
    <div>
        <h3>Tree View</h3>
        <div id="tree-tree-inspector" style="min-height: 350px;"></div>
    </div>
</div>
...
onMounted(async () => {
    ...
    const chartWrapper = document.getElementById('tree-chart-wrapper');
    ...
    const stackedProps = {
        ...
        valueAccessor: 'value',
        groupAccessor: 'date',
        uniqueID: 'tree-view-stacked-bar',
    ...
    // Create both inspectors: force (default) and tree
    ...
    const rendering = dataNavigator.rendering({
        ...
        suffixId: 'tree-view-example',
        root: {
            id: 'tree-chart-wrapper',
    ...
    rendering.initializeCommands({
        rootId: 'tree-commands-container',
